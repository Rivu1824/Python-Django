...
if ($('.tgmenu__action .login-btn').length) {
    // Clone the login button
    var loginBtn = $('.tgmenu__action .login-btn').clone();
    // Append the cloned login button to the mobile menu
    $('.tgmobile__menu .tgmobile__menu-box .tgmobile__menu-outer').append(loginBtn);
}

// Check if there are dropdowns in the main menu
...
if ($('.tgmobile__menu').length) {
    // Copy the content of the main menu to the mobile menu
